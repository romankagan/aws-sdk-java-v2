...
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromBoolean;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromBytes;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromListOfAttributeValues;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromMap;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromNumber;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromSetOfBytes;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromSetOfNumbers;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromSetOfStrings;
import static software.amazon.awssdk.enhanced.dynamodb.converter.attribute.EnhancedAttributeValue.fromString;
...
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.CharSequenceAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.CharacterArrayAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.CharacterAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.PeriodAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.StringAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.StringBufferAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.StringBuilderAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.UriAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.UrlAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.UuidAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.ZoneIdAttributeConverter;
import software.amazon.awssdk.enhanced.dynamodb.converter.attribute.ZoneOffsetAttributeConverter;
