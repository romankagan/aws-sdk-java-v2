...
public class SetAttributeConverter<T extends Collection<?>> implements AttributeConverter<T> {
    ...
    public static <U> SetAttributeConverter<SortedSet<U>> sortedSetConverter(AttributeConverter<U> elementConverter) {
    ...
    public static <U> SetAttributeConverter<NavigableSet<U>> navigableSetConverter(
    ...
    public static <T extends Collection<U>, U> SetAttributeConverter.Builder<T, U> builder(TypeToken<T> collectionType) {
