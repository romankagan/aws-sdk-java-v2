...
import software.amazon.awssdk.enhanced.dynamodb.converter.string.CharacterArrayStringConverter;
...
public final class CharacterArrayAttributeConverter implements AttributeConverter<char[]> {
    ...
    public AttributeValue transformFrom(char[] input) {
        return EnhancedAttributeValue.fromString(CHAR_ARRAY_STRING_CONVERTER.toString(input)).toAttributeValue();
    }
