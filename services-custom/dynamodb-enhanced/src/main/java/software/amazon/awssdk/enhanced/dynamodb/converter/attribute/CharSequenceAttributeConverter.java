...
import software.amazon.awssdk.enhanced.dynamodb.converter.string.CharSequenceStringConverter;
...
public final class CharSequenceAttributeConverter implements AttributeConverter<CharSequence> {
    ...
    public AttributeValue transformFrom(CharSequence input) {
        return EnhancedAttributeValue.fromString(CHAR_SEQUENCE_STRING_CONVERTER.toString(input)).toAttributeValue();
    }
